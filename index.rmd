...
Average daily case increases in Arizona and Pima County have rapidly increased since Memorial Day Weekend. Tuesday, June 23, had a record single-day case increase in Pima County (502). Sunday, June 28, saw a record single-day case increase in Arizona (3,858).
...
NOTE: Data reported by ADHS on 06/29/20 is known to be incomplete as one major lab did not report their new case counts in time for this morning's update. 
...
Hospital COVID-19 specific metrics have been rapidly trending up in the last 3 weeks across Arizona. Hospital in-patient bed usage is currently at 86% and ICU bed usage is at 87% statewide (note that beds in use include both COVID and non-COVID patients).
