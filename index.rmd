...
Average daily case increases in Arizona and Pima County have rapidly increased since Memorial Day Weekend. Tuesday, June 16, had a record single-day case increase Pima County (385), while today, June 18, saw the highest day-to-day case increase in Arizona (2,519).
...
casefig<-ggplot(data=AZPIMACOVID, aes(x=CaseDate, y=AvgIncrease), size=2, alpha=0.7)+
  ...
  scale_y_continuous(name = "Case Increase", breaks = seq(0,2000,100))+
...
Hospital COVID-19 specific metrics have been rapidly trending up in the last 3 weeks across Arizona.
